...
/**
 * Servlet implementation class AcceptTransferController
 */
@WebServlet("/acceptTransfer")
public class AcceptTransferController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AcceptTransferController() {
        super();
...
//		System.out.println(newA.getBalance());
		...
		if(session != null) {
			...
			try {
				bo.acceptTransfer(id);
				out.print("Transfer Acceptance Successful!");
