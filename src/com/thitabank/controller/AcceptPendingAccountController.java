...
/**
 * Servlet implementation class AcceptPendingAccountController
 */
@WebServlet("/acceptPendingAccount")
public class AcceptPendingAccountController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AcceptPendingAccountController() {
        super();
...
//		System.out.println(newA.getBalance());
		...
		if(session != null) {
			...
			try {
				bo.acceptAccount(id);
				out.print("Pending Account Acceptance Successful!");
